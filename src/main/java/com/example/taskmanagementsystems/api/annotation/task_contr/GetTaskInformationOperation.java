...
@ApiResponses(value = {
    ...
    @ApiResponse(responseCode = "200",
        ...
        content = @Content(mediaType = "application/json",
            ...
            examples = @ExampleObject(
                value = "{\"taskId\": \"f05cdd27-d303-49f6-9bbc-301a0428c738\","
                    + " \"title\": \"Разработка системы управления задачами\","
                    + " \"description\": \"Разработать простую систему управления задачами с использованием Java, Spring.\","
                    + " \"status\": \"PENDING\","
                    + " \"priority\": \"HIGH\","
    ...
    @ApiResponse(responseCode = "400",
        ...
        content = @Content(mediaType = "application/json",
            ...
            examples = @ExampleObject(
                value = "{\"uri\": \"/api/task-service/e0899cf2-ad18-4add-b378-cde9bc0e6850\","
                    + "\"type\": \"BadRequestException\","
                    + "\"message\": \"Task with Id e0899cf2-ad18-4add-b378-cde9bc0e6850 not found\","
    ...
    @ApiResponse(responseCode = "401",
        ...
        content = @Content(mediaType = "application/json",
            ...
            examples = @ExampleObject(
                value =
                    "{\"path\": \"/api/task-service/e0899cf2-ad18-4add-b378-cde9bc0e6850\","
                        + "\"error\": \"Unauthorized\","
